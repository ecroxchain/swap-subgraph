...
export function updatePancakeDayData(event: ethereum.Event): PancakeDayData {
  ...
  pancakeDayData.totalLiquidityUSD = pancake!.totalLiquidityUSD || BigDecimal.fromString("0");
  pancakeDayData.totalLiquidityBNB = pancake!.totalLiquidityBNB || BigDecimal.fromString("0");
  pancakeDayData.totalTransactions = pancake!.totalTransactions || BigInt.fromString("0");
  pancakeDayData.save();
...
export function updatePairHourData(event: ethereum.Event): PairHourData {
  ...
  pairHourData.totalSupply = pair!.totalSupply || BigDecimal.fromString("0");
  pairHourData.reserve0 = pair!.reserve0 || BigDecimal.fromString("0");
  pairHourData.reserve1 = pair!.reserve1 || BigDecimal.fromString("0");
  pairHourData.reserveUSD = pair!.reserveUSD || BigDecimal.fromString("0");
...
export function updateTokenDayData(token: Token, event: ethereum.Event): TokenDayData {
  ...
  if (tokenDayData === null) {
    ...
    tokenDayData.priceUSD = token!.derivedBNB!.times(bundle!.bnbPrice || BigDecimal.fromString("0"));
  ...
  tokenDayData.totalLiquidityUSD = tokenDayData.totalLiquidityBNB.times(bundle!.bnbPrice || BigDecimal.fromString("0"));
